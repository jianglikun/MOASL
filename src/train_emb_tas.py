...
def train_all(data_dir,fold,batch_size,num_epoch,device,logname,embeding_size):
    ...
    model, loss_func, mining_func, optimizer = define_model(device,embeding_size)
    ...
    test_log_df.to_csv('{}/src/result_emb_tas/all_fold{}_{}_embedding_{}.csv'.format(data_dir,fold, logname,embeding_size))
...
if __name__ == '__main__':
    ...
    for emb in [16,32,64,128,256,512,1024]:
        for fold in [0,1,2]:
